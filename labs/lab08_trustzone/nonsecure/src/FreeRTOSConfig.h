 ...
 *   configENABLE_TRUSTZONE         = 0  -- using NTZ port in practice
 ...
 *   Using the NTZ (Non-TrustZone) port variant in practice.
 *   Set to 1 if switching to the ARM_CM33 (TZ-aware) port.
 */
