...
\begin{warnbox}
  ...
  Hardware initialisation is handled by \texttt{BOARD\_InitHardware()}. Use
  \texttt{PRINTF} from \texttt{fsl\_debug\_console.h} for console output. Switch
  between binary semaphore and mutex by changing \texttt{\#define USE\_MUTEX} in
  \file{main.c}.
\end{warnbox}
...
mingw32-make && mingw32-make flash
\end{lstlisting}
